...
func (m *Loan) GetTimestamp() int64 {
	if m != nil {
		return m.Timestamp
	}
	return 0
...
var fileDescriptor_c51a16ffe2d36ee8 = []byte{
	...
	,
}
...
func (m *Loan) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Timestamp != 0 {
		i = encodeVarintLoan(dAtA, i, uint64(m.Timestamp))
		i--
		dAtA[i] = 0x48
	}
	if len(m.Lender) > 0 {
...
func (m *Loan) Size() (n int) {
	...
	if m.Timestamp != 0 {
		n += 1 + sovLoan(uint64(m.Timestamp))
	}
	return n
}
